...
작업을 시작할 때는 먼저 `Assets/06_Markdown/MAP.md`에서 대상 영역의 참고 문서를 확인한다.

---

## Codex 작업 원칙

- 작업 전 `Assets/06_Markdown/MAP.md`와 변경 대상 영역 문서를 읽고, 기존 구조와 패턴을 우선 따른다.
...
- 작업 규모에 따라 단독 진행 또는 팀 에이전트 진행을 선택한다. 상세는 `Assets/06_Markdown/07_Agents/AGENT_TEAM.md` 참고.
...
| 작업 | 문서 |
|------|------|
| **문서 네비게이션** | **`Assets/06_Markdown/MAP.md`** |
| **팀 에이전트 운용** | **`Assets/06_Markdown/07_Agents/AGENT_TEAM.md`** |
